...
const Footer = () => {
  return (
    <footer className="bg-[#1C3166] text-[#40FFDC]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Sección superior: 2 columnas */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Seccion 1 */}
          <div>
            <h3 className="text-lg font-bold mb-2 text-[#00A9D4]">InfoGamer</h3>
            <p className="text-[#40FFDC]">
            InfoGamer es la plataforma ideal para los amantes de los videojuegos. Aquí encontrarás información rápida y accesible sobre los títulos más conocidos, además de reseñas, recomendaciones de sitios de descarga, tutoriales para mejorar tu experiencia de juego y mucho más. Nuestro objetivo es brindarte todo lo que necesitas para estar siempre al día en el mundo gamer.
            </p>
          </div>
            {/* Seccion 2 */}
          <div className="md:text-right">
            <h3 className="text-lg font-bold mb-2 text-[#00A9D4]">Comunidad</h3>
        ...
        {/* Sección inferior: logos centrados */}
        <div className="mt-8 text-center">
          <h3 className="text-lg font-bold mb-4 text-[#00A9D4]">Plataformas Principales</h3>
